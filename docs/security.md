...
Security controls include validation, sanitization, CORS, rate limiting, security headers, `.env`, secret masking, Bandit, pip-audit, npm audit, CodeQL and Dependabot.
