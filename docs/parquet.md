...
Analytical data is generated with Polars and PyArrow into partitioned paths for prices, dividends and news. DuckDB can query aggregate counts over generated Parquet.
